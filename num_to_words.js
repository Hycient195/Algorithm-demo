...
const num2words_input = document.querySelector('#num_to_words_input');
const num2words_output = document.querySelector('#num_to_words_output');

num2words_input.addEventListener('input', (e)=>{
  num2words_output.textContent = numToWords(Number(num2words_input.value))
})
...
function numToWords(num){
  ...
  while(numVar >= 10000){
    result += 'ten thousand '
    numVar -= 10000;
    numVar !== 0 && numVar <= 99 ? result += 'and ' : null;
  }
